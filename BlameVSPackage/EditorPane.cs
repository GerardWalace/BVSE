...
namespace GerardWalace.BlameVSPackage
{
    ...
    //     - An empty blame file in the same directory as NewFileItems.vsdir. In
    //       our case we chose BlameTmp.blame. Note this file name appears in Editor.vsdir
    ...
    //          - "BlameTmp" - This is the base file name. New files will initially
    //             be named as BlameTmp1.blame, BlameTmp2.blame... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    BlameTmp.blame|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - BlameTmp.blame - our empty blame file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".blame";
        ...
        #region Fields
        private BlameVSPackagePackage myPackage;
        ...
        public EditorPane(BlameVSPackagePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the blame document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(BlameVSPackagePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidBlameVSPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidBlameVSPackageCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidBlameVSPackageEditorFactory;
            return VSConstants.S_OK;
        }
