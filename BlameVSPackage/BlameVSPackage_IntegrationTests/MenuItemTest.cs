...
namespace BlameVSPackage_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(GerardWalace.BlameVSPackage.GuidList.guidBlameVSPackageCmdSet, (int)GerardWalace.BlameVSPackage.PkgCmdIDList.cmdidBlame);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "BlameVSPackage", "GerardWalace.BlameVSPackage.BlameVSPackagePackage");
