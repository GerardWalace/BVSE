...
namespace BlameVSPackage_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(GerardWalace.BlameVSPackage.GuidList.guidBlameVSPackageCmdSet, (int)GerardWalace.BlameVSPackage.PkgCmdIDList.cmdidBlame);
