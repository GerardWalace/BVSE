...
namespace GerardWalace.BlameVSPackage
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".blame", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "BlameVSPackage")]
    [ProvideKeyBindingTable(GuidList.guidBlameVSPackageEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidBlameVSPackagePkgString)]
    public sealed class BlameVSPackagePackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidBlameVSPackageCmdSet, (int)PkgCmdIDList.cmdidBlame);
