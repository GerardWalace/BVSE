...
namespace GerardWalace.BlameVSPackage
{
    ...
    /// </summary>
    [Guid(GuidList.guidBlameVSPackageEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private BlameVSPackagePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(BlameVSPackagePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidBlameVSPackageEditorFactory;
            pgrfCDW = 0;
